...
export default class RyanScreenshotFixes extends Common {
  ...
  private Mimibeltupdatefooter() {
    this.dom
      ...
      .forEach((footer) => {
        const childElement = footer.querySelector(
    ...
    this.dom
      .querySelectorAll(".footer__blocks-wrapper.grid .footer-block.grid__item")
      .forEach(
        (childBlock) => ((childBlock as HTMLElement).style.opacity = "1")
      );
  }
