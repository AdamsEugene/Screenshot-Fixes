...
export default class JoeScreenshotFixes extends Common {
    ...
    private resolveMenuIssueKeyStoneWalls() {
        try {
            ...
            const child = parent.querySelector(".fa.fa-bars") as HTMLElement;
            ...
            if (child) {
                parent.addEventListener("click", () => {
                    ...
                    if (menu) {
                        menu.classList.toggle("mm-opened");
                    }
                });
            }
        } catch (error) {}
        ...
        setInterval(() => {
            try {
                ...
                toggleButton.addEventListener("click", () => {
                    const menuInner = this.dom.querySelector(
                        ".mobile-menu-inner-wrapper .mobile-menu-inner"
                    ) as HTMLElement;
